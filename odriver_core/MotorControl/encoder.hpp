...
public:
    ...
    OutputPort<float> pos_circular_ = 0.0f;
    ...
    float pll_pos_ = 0.0f;
    float pll_vel_ = 0.0f;
    float pos_estimate_counts_prev_ = 0.0f;
};
#endif // __ENCODER_HPP