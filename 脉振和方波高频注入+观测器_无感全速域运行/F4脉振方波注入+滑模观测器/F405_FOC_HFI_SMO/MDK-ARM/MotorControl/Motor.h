...
#define TIM1_Period					4200			//定时器1的重装载值
#define TIM1_Period_Half 		2100			//定时器1重装载值的一半
...
#define HFI_Uin_offset 		3.0f			//HFI注入高频电压偏置
...
#define ONE_OVER_TWOPI	0.159154943091896f	//1/(2PI)
...
#define Speed_Ref_Max				7000	//目标速度上限值，机械角速度

#define HFI_Speed_Ref_Max		350		//HFI最大转速速度限制

#define Motor_Freq_Min      2			//定义频率的最小值
#define Motor_Freq_Max  	  120		//定义频率最大值

#define Protect_Low_Voltage_V     9.0f 	//低压保护
#define Standard_Work_Voltage_V   12.0f	//标准工作电压
#define Protect_High_Voltage_V    15.0f //高压保护
...
void 		JScope_Data_Send(s16 *data, u8 Number);		//J_Scope数据发送
