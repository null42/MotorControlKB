...
#define ENCODER_Z_GPIO_CLK         RCC_AHB1Periph_GPIOB
#define ENCODER_Z_SOURCE           GPIO_PinSource10
#define ENCODER_Z_AF               GPIO_AF_TIM2
#define ENCODER_Z_EXTI_GPIO_PORT   EXTI_PortSourceGPIOB
#define ENCODER_Z_EXTI_SOURCE      EXTI_PinSource10
#define ENCODER_Z_EXTI_LINE        EXTI_Line10
//encoder sensor define end
