...
#define MotorTask_Init_Flow_ADC_Read    MotorTask_Init_Flow_ADC_Read_Three_T
#define MotorTask_Run_Flow_ADC_Read     MotorTask_Run_Flow_ADC_Read_Three_T
#define MotorTask_Run_Flow_PWM_Set      MotorTask_Run_Flow_PWM_Set_Three_T
#elif MCFOC_CJYS_1
#define MCFOC_Offset_Check              MCFOC_Offset_Check_One_T
#define MotorTask_Init_Flow_ADC_Read    MotorTask_Init_Flow_ADC_Read_One_T
#define MotorTask_Run_Flow_ADC_Read     MotorTask_Run_Flow_ADC_Read_One_T
#define MotorTask_Run_Flow_PWM_Set      MotorTask_Run_Flow_PWM_Set_One_T
#endif

#if (MOTOR_EST_MODE == MOTOR_EST_SMO)
#define Motor_EST_FUNCTION              MCFOC_EST_SMO_T(&pMotor->SMO_CTRL, &pMotor->PMSM_ELEC_CTRL);
#define Motor_EST_Freq                  SMO_CTRL.FL_SMO_FREQ.Q14I_LPF_Out
...
#define Motor_EST_FUNCTION              MCFOC_EST_FLUX_T(&pMotor->FLUX_CTRL, &pMotor->PMSM_ELEC_CTRL);
#define Motor_EST_Freq                  FLUX_CTRL.FL_FLUX_FREQ.Q14I_LPF_Out
...
#define MOTOR_SMO_PLL_KI                    ((Q32I_)(MATH_SQUARE_F(MOTOR_PLL_Coeff * MOTOR_MAX_SRAD) * MOTOR_HTs * 2.0f / VOLTAGE_PU / F_BASE / MATH_2PI_F * 16384.0f))      //锁相环积分系数
...
#define MOTOR_FLUX_PLL_KI                   ((Q32I_)(MATH_SQUARE_F(MOTOR_PLL_Coeff * MOTOR_MAX_SRAD) * MOTOR_HTs / FLUX_PU / F_BASE / MATH_2PI_F * 16384.0f))                //锁相环积分系数
...
typedef struct{
    ...
    ST_PMSM_FILTER_T            PMSM_FILTER_CTRL;
    ST_PMSM_ELEC_T              PMSM_ELEC_CTRL;
    ST_PMSM_PARA_T              PMSM_PARA_CTRL;
