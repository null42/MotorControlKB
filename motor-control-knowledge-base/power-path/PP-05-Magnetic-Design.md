...
> 📎 **交叉引用**：电机电感参数（Ld/Lq）如何影响 FOC 的电流环 PI 设计（$$K_p = L_s \cdot \omega_{bw}$$）→ [ALG-01 FOC 理论基础](../algorithm/ALG-01-FOC-Theory.md) | [ALG-13 有感 FOC](../algorithm/ALG-13-Sensored-FOC.md#5-参数整定)
